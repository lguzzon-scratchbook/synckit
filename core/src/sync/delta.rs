...
pub fn merge_deltas(delta1: &Delta, delta2: &Delta) -> Delta {
    assert_eq!(delta1.document_id, delta2.document_id, "Cannot merge deltas for different documents");
...
mod tests {
    ...
    fn test_compute_delta_multiple_changes() {
        ...
        new.set_field("title".to_string(), json!("Title"), 1, "client1".to_string());
        new.set_field("body".to_string(), json!("Body"), 2, "client1".to_string());
        new.set_field("author".to_string(), json!("Alice"), 3, "client1".to_string());
    ...
    fn test_delta_roundtrip() {
        ...
        new.set_field("title".to_string(), json!("Hello"), 1, "client1".to_string());
