...
- **Full-Featured**: Uses SyncKit default (~59 KB gzipped) - all features included
...
- **SyncKit** (~59KB gzipped): Full offline-first capabilities with WASM portability
